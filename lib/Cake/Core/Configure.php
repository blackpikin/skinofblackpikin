			...
			if (!include APP . 'Config' . DS . 'core.php') {
				trigger_error(__d('cake_dev',
					...
					E_USER_ERROR
                        ...
                        if (!include APP . 'Config' . DS . 'Configinc.php') {
				trigger_error(__d('cake_dev',
						"Can't find application configinc file. Please create %s, and make sure it is readable by PHP.",
						APP . 'Config' . DS . 'Configinc.php'),
					E_USER_ERROR
				);
			}
                        
                        if (!include APP . 'Config' . DS . 'Settings.php') {
				trigger_error(__d('cake_dev',
						"Can't find application configinc file. Please create %s, and make sure it is readable by PHP.",
						APP . 'Config' . DS . 'Settings.php'),
					E_USER_ERROR
				);
			}
